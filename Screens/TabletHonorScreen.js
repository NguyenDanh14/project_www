...
const TabletHonorScreen = ({ navigation }) => {
    const seriesList = [
        "Honor MediaPad Series",
        "Honor Pad Series",
        "Honor Tab Series",
      ];
      const products = [
        {
          id: 1,
          name: "Honor MediaPad T3 10 16GB",
          description: "",
          image: require("../assets/DATA/Honor1.webp"), // Update with actual path
        },
        {
          id: 2,
          name: "Honor MediaPad T3 10 32GB",
          description: "",
          image: require("../assets/DATA/Honor1.webp"), // Update with actual path
        },
        {
          id: 3,
          name: "Honor MediaPad T3 8.0 16GB",
          description: "",
          image: require("../assets/DATA/Honor3.webp"), // Update with actual path
        },
        {
          id: 4,
          name: "Honor Pad 5 10.1 32GB",
          description: "",
          image: require("../assets/DATA/Honor5.webp"), // Update with actual path
        },
        {
          id: 5,
          name: "Honor Pad 5 10.1 64GB",
          description: "",
          image: require("../assets/DATA/Honor7.webp"), // Update with actual path
        },
        {
          id: 6,
          name: "Honor Pad 5 8 32GB",
          description: "",
          image: require("../assets/DATA/Honor9.webp"), // Update with actual path
        },
        {
          id: 7,
          name: "Honor Pad 5 8 64GB",
          description: "",
          image: require("../assets/DATA/Honor1.webp"), // Update with actual path
        },
      ];
      const productList = [
        {
          ...
          name: "Honor MediaPad T3 10 16GB",
          description: "",
          image: require("../assets/DATA/Honor1.webp"),
        },
        {
          id: 2,
          name: "Honor MediaPad T3 10 32GB",
        ...
        },
        {
          ...
          name: "Honor MediaPad T3 8.0 16GB",
          description: "",
          image: require("../assets/DATA/Honor3.webp"),
        },
        {
          id: 4,
          name: "Honor MediaPad T3 8.0 32GB",
          description: "",
          image: require("../assets/DATA/Honor3.webp"),
        },
        {
          ...
          name: "Honor Pad 5 10.1 32GB",
          description: "",
          image: require("../assets/DATA/Honor5.webp"),
        },
        {
          id: 6,
          name: "Honor Pad 5 10.1 64GB",
        ...
        },
        {
          ...
          name: "Honor Pad 5 8 32GB",
          description: "",
          image: require("../assets/DATA/Honor7.webp"),
        },
        {
          id: 8,
          name: "Honor Pad 5 8 64GB",
        ...
        {
          id: 9,
          name: "Honor Tab 5 32GB",
          description: "",
          image: require("../assets/DATA/Honor9.webp"),
        },
        {
          id: 10,
          name: "Honor Tab 5 64GB",
          description: "",
          image: require("../assets/DATA/Honor9.webp"),
        },
      ];
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.navigation}>
        ...
        <Text style={styles.separator}> &gt; </Text>
        <Text style={styles.activeLink}>Sell Old Honor</Text>
      </View>
      {/* Select Series Title */}
...
export default TabletHonorScreen;
