  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.navigation}>
        ...
        <Text style={styles.navigationText}>Sell Old Tablet</Text>
      </View>
