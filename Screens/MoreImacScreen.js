...
const MoreImacScreen = ({ navigation }) => {
  const features = [
    {
      id: 1,
      title: "Best Prices",
  ...
  const products = [
    {
      id: 1,
      name: "iMac 21.5 inches",
      description: "",
      image: require("../assets/DATA/imac1.webp"), // Update with actual path
    },
    {
      id: 2,
      name: "iMac 27 inches",
      description: "",
      image: require("../assets/DATA/imac2.webp"), // Update with actual path
    },
    {
      id: 3,
      name: "iMac 24 inches",
      description: "",
      image: require("../assets/DATA/imac3.webp"), // Update with actual path
    }
  ];
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.navigation}>
        ...
        <Text style={styles.navigationText}>Sell Old iMac</Text>
      </View>
