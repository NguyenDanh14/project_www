  ...
  const faqData = [
    {
      ...
      answer: "You can turn in your old phones at participating stores or through our online service.",
    },
    {
      question: "How can I sell my old cell phone?",
      answer: "Simply check the price, schedule a pickup, and get paid when your phone is collected.",
    },
    {
      question: "What do you do with my old phone?",
      answer: "We either refurbish, recycle, or resell the phones depending on their condition.",
    },
  ];
  return (
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.contentHeader}>
        <Image source={require('../assets/DATA/logo.png')} style={styles.logoHeader} />
      ...
      {/* Navigation Content */}
      <ScrollView horizontal style={styles.contentHeaderNav} showsHorizontalScrollIndicator={false}>
        {[
          'All',
          'Sell Phone',
          'Sell Gadgets',
      ...
      <View style={styles.navigation}>
        ...
        <Text style={styles.navigationText}>Sell Old Smartwatch</Text>
      </View>
      ...
      <View style={styles.content}>
        <View style={styles.textContainer}>
          ...
          <TouchableOpacity style={styles.brandButton}>
            <Text style={styles.brandButtonText}>Apple</Text>
          </TouchableOpacity>
        </View>
    ...
    <View style={styles.containerDownload}>
      ...
      <View style={styles.contentSell}>
        <Text style={styles.textContent}>
          ...
          Sell Old Motorola Mobile Sell Old Google Mobile Sell Old Lenovo Mobile
          Sell Old OnePlus Mobile {"\n"}
          Sell Old Oppo Mobile Sell Old Vivo Mobile Sell Old Huawei Mobile Sell
          Old Asus Mobile Sell Old Nokia Mobile Sell Old Sony Mobile Sell Old LG
          Mobile Sell Old Panasonic {"\n"} Mobile Sell Old Gionee Mobile Sell Old LeEco
          Mobile Sell Old Micromax Mobile Sell Old HTC Mobile Sell Old Coolpad
          Mobile Sell Old Xolo Mobile Sell Old Intex Mobile Sell Old Karbonn
          Mobile Sell Old Lava Mobile
        </Text>
      </View>
    </View>
