...
const MoreCameraScreen = ({ navigation }) => {
  const features = [
    {
      id: 1,
      title: "Best Prices",
  ...
  const products = [
    {
      id: 1,
      name: "Nikon Coolpix P90",
      description: "",
      image: require("../assets/DATA/cam1.webp"), // Update with actual path
    },
    {
      id: 2,
      name: "Nikon Coolpix P100",
      description: "",
      image: require("../assets/DATA/cam2.webp"), // Update with actual path
    },
    {
      id: 3,
      name: "Nikon Coolpix P500",
      description: "",
      image: require("../assets/DATA/cam1.webp"), // Update with actual path
    },
    {
    ...
    {
      id: 6,
      name: "Nikon Coolpix P530",
      description: "",
      image: require("../assets/DATA/cam2.webp"), // Update with actual path
    },
    {
      id: 7,
      name: "Nikon Coolpix P600",
      description: "",
      image: require("../assets/DATA/cam3.webp"), // Update with actual path
    },
  ];
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.navigation}>
        ...
        <Text style={styles.navigationText}>Sell Old DSLR Camera</Text>
      </View>
...
export default MoreCameraScreen;
