...
const TabletSamsungScreen = ({ navigation }) => {
    const seriesList = [
        "Galayxy Tab A Series",
        "Galayxy Tab S Series",
        "Other Samsung Tab",
      ];
      const products = [
        {
          ...
          description: "",
          image: require("../assets/DATA/samsung1.webp"), // Update with actual path
        },
        {
          id: 2,
          name: "Samsung Galaxy Tab S3 LTE",
          description: "",
          image: require("../assets/DATA/samsung2.webp"), // Update with actual path
        },
        {
          id: 3,
          name: "Samsung Galaxy Tab A 9.7 Wifi",
          description: "",
          image: require("../assets/DATA/samsung3.webp"), // Update with actual path
        },
        {
          id: 4,
          name: "Samsung Galaxy Tab A 10.5 LTE",
          description: "",
          image: require("../assets/DATA/samsung4.webp"), // Update with actual path
        },
        {
          id: 5,
          name: "Samsung Galaxy Tab S 8.4 LTE",
          description: "",
          image: require("../assets/DATA/samsung5.webp"), // Update with actual path
        },
        {
          id: 6,
          name: "Samsung Galaxy Tab S 10.5 LTE",
          description: "",
          image: require("../assets/DATA/samsung6.webp"), // Update with actual path
        },
        {
          id: 7,
          name: "Samsung Galaxy Tab S2 9.7 LTE",
          description: "",
          image: require("../assets/DATA/samsung7.webp"), // Update with actual path
        },
      ];
      const productList = [
        {
          ...
          name: "Samsung Galaxy Tab S3 LTE",
          description: "",
          image: require("../assets/DATA/samsung1.webp"),
        },
        {
          id: 2,
          name: "Samsung Galaxy Tab S3 LTE",
          description: "",
          image: require("../assets/DATA/samsung2.webp"),
        },
        {
          id: 3,
          name: "Samsung Galaxy Tab A 9.7 Wifi",
          description: "",
          image: require("../assets/DATA/samsung3.webp"),
        },
        {
          id: 4,
          name: "Samsung Galaxy Tab A 10.5 LTE",
          description: "",
          image: require("../assets/DATA/samsung4.webp"),
        },
        {
          id: 5,
          name: "Samsung Galaxy Tab S 8.4 LTE",
          description: "",
          image: require("../assets/DATA/samsung5.webp"),
        },
        {
          id: 6,
          name: "Samsung Galaxy Tab S 10.5 LTE",
          description: "",
          image: require("../assets/DATA/samsung6.webp"),
        },
        {
          id: 7,
          name: "Samsung Galaxy Tab S2 9.7 LTE",
          description: "",
          image: require("../assets/DATA/samsung7.webp"),
        },
        {
          id: 8,
          name: "Samsung Galaxy Tab A7 10.4 Wifi",
          description: "",
          image: require("../assets/DATA/samsung8.webp"),
        },
        {
          id: 9,
          name: "Samsung Galaxy Tab S10 Ultra Wifi Only",
          description: "",
          image: require("../assets/DATA/samsung9.webp"),
        },
        {
          id: 10,
          name: "Samsung Galaxy Tab S10 Ultra Wifi 5G",
          description: "",
          image: require("../assets/DATA/samsung10.webp"),
        },
      ];
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.navigation}>
        ...
        <Text style={styles.separator}> &gt; </Text>
        <Text style={styles.activeLink}>Sell Old Samsung</Text>
      </View>
      {/* Select Series Title */}
...
export default TabletSamsungScreen;
