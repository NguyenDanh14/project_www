...
const MoreTVScreen = ({ navigation }) => {
  ...
  const products = [
    {
      id: 1,
      name: "Coocaa 32 to 35 inches TV",
      description: "",
      image: require("../assets/DATA/cooca.webp"), // Update with actual path
    },
    {
      id: 2,
      name: "Coocaa 36 to 40 inches TV",
      description: "",
      image: require("../assets/DATA/cooca.webp"), // Update with actual path
    },
    {
      id: 3,
      name: "Coocaa 41 to 50 inches TV",
      description: "",
      image: require("../assets/DATA/cooca.webp"), // Update with actual path
    },
    {
      id: 4,
      name: "Coocaa 51 to 60 inches TV",
      description: "",
      image: require("../assets/DATA/cooca.webp"), // Update with actual path
    },
    {
      id: 5,
      name: "Coocaa 61 to 70 inches TV",
      description: "",
      image: require("../assets/DATA/cooca.webp"), // Update with actual path
    },
    {
      id: 6,
      name: "Coocaa 71 to 80 inches TV",
      description: "",
      image: require("../assets/DATA/cooca.webp"), // Update with actual path
    },
    {
      id: 7,
      name: "Coocaa 81 to 90 inches TV",
      description: "",
      image: require("../assets/DATA/cooca.webp"), // Update with actual path
    },
  ];
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.navigation}>
        ...
        <Text style={styles.navigationText}>Sell Old Television</Text>
      </View>
